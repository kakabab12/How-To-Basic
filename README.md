...
| 📐 **로보틱스 2026** | 라인트레이싱 로봇 설계 문서 9편 (코드 없음) | **12챕터** | [로보틱스 2026/](로보틱스%202026/README.md) |
...
| 브랜치 | `main` | `main` |
| 파일 수 | **6,874개** | **35개** |
| 커밋 | 6개 (2026-06-28 ~ 07-13) | 2개 (2026-07-13 ~ 07-15) |
| 프로젝트 | **6개** | **1개** (`광명테크/gesture_model`) |
...
> **파일 수에 속지 말 것.** 6,874개 중 **6,052개가 남의 코드(node_modules + lerobot)**이거나
...
> 이 설정으로 **6,874개 파일이 전부 정상 체크아웃**되는 것을 확인했다.
>
